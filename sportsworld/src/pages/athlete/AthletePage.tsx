...
const AthletePage = () => {
    return (
        <>
         <header>
                <h2 className="text-4xl p-8 mb-8 flex flex-col items-center">Liste over alle fotballspillere</h2>
            </header>
        ...
        <h2 className="text-lg">Search for Athletes</h2>
            <div className=""><AthleteSearchByName/></div>
            <div className=""><AthleteSearchById/></div>
        </section>
